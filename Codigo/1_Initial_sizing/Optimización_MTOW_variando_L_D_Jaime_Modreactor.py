# -*- coding: utf-8 -*-
"""
Created on Thu Mar 12 18:36:12 2026
...
W_TO = opti.variable(init_guess=80, lower_bound=30) # Masa total [kg]
...
V_loiter = 130         # Velocidad de loiter recomendada [m/s]
...
CD0 = 0.07              # Resistencia parásita preliminar
...
# --- 5. PROPULSIÓN Y PESOS (Breguet para REACTOR) ---

# TSFC: Thrust Specific Fuel Consumption
TSFC_kg_per_N_hr = 1.0      # [kg/(N·h)] AJUSTAR según motor
TSFC = TSFC_kg_per_N_hr / 3600.0  # -> [kg/(N·s)]

W_arranque = 0.99
W_despegue = 0.995
W_ascenso  = 0.985

t_loiter = autonomia_h * 3600.0  # [s]

# Breguet LOITER para JET (no depende de V)
W_loiter_frac = np.exp( - TSFC * t_loiter / L_D_loiter )
